...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private void makeGithubSearchQuery() {
        ...
        if (TextUtils.isEmpty(githubQuery) || githubQuery == null) {
            mUrlDisplayTextView.setText("No Query entered to  search");
            return;
        }
        ...
        Log.e("makeGithubSearchQuery", "Value of githubsearchUrl: " +githubSearchUrl.toString());
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                Log.e(" LoadInBackground", "Bundle Value: " +string);

                Log.e(" LoadInBackground", "Value of SEARCH_QUERY_URL_EXTRA: " +args.getString(SEARCH_QUERY_URL_EXTRA));
                Log.e(" LoadInBackground", "Value of url: " +url);
